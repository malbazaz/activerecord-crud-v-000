...
def can_be_found_updated_and_saved
  ...
  movie_01 = Movie.find_by(title: "Awesome Flick")
  movie_01.title = "Even Awesomer Flick"
  movie_01.save
end
...
def can_update_using_update_method
  ...
  movie_01 = Movie.find_by(title: "Wat?")
  movie_01.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  movie_01 = Movie.all.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  movie_01.destroy
end
